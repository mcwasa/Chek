...
def file():
	os.system('clear')
	print(' \033[1;37mExample \033[1;31m: \033[1;32m/sdcard/Xyteee.py');print(led)
...
#---------------------[File-Setting]---------------------#
def setting():
    print(f' [1] New Ids Crack ');print(f' [2] Old Ids Crack');print(f' [3] Mix Ids Crack');print(led)
...
def Fast():
  ...
  print(dt) #;print(f" {P}Number : "+kode);print(led)
  print(f'{P} [1] Method async ≥ {H}m.facebook.com{P}');print(f' [2] Method validate ≥ {H}mbasic.facebook.com{P}');print(f' [3] Method regular ≥{H} business.facebook.com {P}');print(led)
